...
public class StockDayDetails extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		loadStockTransactions(code,date);
    }
	
	private void loadStockTransactions(String code,String date){
		m_downlowdStockDayDeals = dbmgr.queryStockDeals(code,date);
    ...
    private class MyRunnable implements Runnable{
        ...
        public void run(){
            ...
            try
            {
                ...
                if(result != null){
                    m_downlowdStockDayDeals = StockDayDeal.parse(result);
                }
